<?php
namespace Webinc\Review\Block\Review;

/**
 * Interceptor class for @see \Webinc\Review\Block\Review
 */
class Interceptor extends \Webinc\Review\Block\Review implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTabTitle');
        if (!$pluginInfo) {
            return parent::setTabTitle();
        } else {
            return $this->___callPlugins('setTabTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionSize');
        if (!$pluginInfo) {
            return parent::getCollectionSize();
        } else {
            return $this->___callPlugins('getCollectionSize', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductReviewUrl');
        if (!$pluginInfo) {
            return parent::getProductReviewUrl();
        } else {
            return $this->___callPlugins('getProductReviewUrl', func_get_args(), $pluginInfo);
        }
    }
