<?php
namespace MagicToolbox\MagicZoomPlus\Block\Product\View\Gallery;

/**
 * Interceptor class for @see \MagicToolbox\MagicZoomPlus\Block\Product\View\Gallery
 */
class Interceptor extends \MagicToolbox\MagicZoomPlus\Block\Product\View\Gallery implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEscaper');
        if (!$pluginInfo) {
            return parent::getEscaper();
        } else {
            return $this->___callPlugins('getEscaper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGalleryImagesCollection');
        if (!$pluginInfo) {
            return parent::getGalleryImagesCollection($product);
        } else {
            return $this->___callPlugins('getGalleryImagesCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOriginalBlock');
        if (!$pluginInfo) {
            return parent::getOriginalBlock();
        } else {
            return $this->___callPlugins('getOriginalBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAnotherBlock');
        if (!$pluginInfo) {
            return parent::getAnotherBlock();
        } else {
            return $this->___callPlugins('getAnotherBlock', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isCooperativeModeAllowed');
        if (!$pluginInfo) {
            return parent::isCooperativeModeAllowed();
        } else {
            return $this->___callPlugins('isCooperativeModeAllowed', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRenderedHtml');
        if (!$pluginInfo) {
            return parent::getRenderedHtml($id);
        } else {
            return $this->___callPlugins('getRenderedHtml', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function renderGalleryHtml($product = null, $isAssociatedProduct = false, $data = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderGalleryHtml');
        if (!$pluginInfo) {
            return parent::renderGalleryHtml($product, $isAssociatedProduct, $data);
        } else {
            return $this->___callPlugins('renderGalleryHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPlaceholderHtml');
        if (!$pluginInfo) {
            return parent::getPlaceholderHtml();
        } else {
            return $this->___callPlugins('getPlaceholderHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBreakpoints');
        if (!$pluginInfo) {
            return parent::getBreakpoints();
        } else {
            return $this->___callPlugins('getBreakpoints', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getGalleryImagesJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getGalleryImagesJson();
        } else {
            return $this->___callPlugins('getGalleryImagesJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGalleryUrl');
        if (!$pluginInfo) {
            return parent::getGalleryUrl($image);
        } else {
            return $this->___callPlugins('getGalleryUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isMainImage');
        if (!$pluginInfo) {
            return parent::isMainImage($image);
        } else {
            return $this->___callPlugins('isMainImage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageAttribute');
        if (!$pluginInfo) {
            return parent::getImageAttribute($imageId, $attributeName, $default);
        } else {
            return $this->___callPlugins('getImageAttribute', func_get_args(), $pluginInfo);
        }
    }
