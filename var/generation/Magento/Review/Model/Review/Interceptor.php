...
class Interceptor extends \Magento\Review\Model\Review implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStatusCollection');
        if (!$pluginInfo) {
            return parent::getStatusCollection();
        } else {
            return $this->___callPlugins('getStatusCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEntitySummary');
        if (!$pluginInfo) {
            return parent::getEntitySummary($product, $storeId);
        } else {
            return $this->___callPlugins('getEntitySummary', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPendingStatus');
        if (!$pluginInfo) {
            return parent::getPendingStatus();
        } else {
            return $this->___callPlugins('getPendingStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductUrl($productId, $storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductUrl($productId, $storeId);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'appendSummary');
        if (!$pluginInfo) {
            return parent::appendSummary($collection);
        } else {
            return $this->___callPlugins('appendSummary', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isApproved');
        if (!$pluginInfo) {
            return parent::isApproved();
        } else {
            return $this->___callPlugins('isApproved', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAvailableOnStore');
        if (!$pluginInfo) {
            return parent::isAvailableOnStore($store);
        } else {
            return $this->___callPlugins('isAvailableOnStore', func_get_args(), $pluginInfo);
        }
    }
