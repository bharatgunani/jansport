...
class Interceptor extends \Magento\Review\Block\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRatings');
        if (!$pluginInfo) {
            return parent::getRatings();
        } else {
            return $this->___callPlugins('getRatings', func_get_args(), $pluginInfo);
        }
    }
