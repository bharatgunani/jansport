...
class Interceptor extends \Magestore\OneStepCheckout\Plugin\Catalog\Helper\Image implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterGetWidth');
        if (!$pluginInfo) {
            return parent::afterGetWidth($subject, $result);
        } else {
            return $this->___callPlugins('afterGetWidth', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterGetHeight');
        if (!$pluginInfo) {
            return parent::afterGetHeight($subject, $result);
        } else {
            return $this->___callPlugins('afterGetHeight', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFullRequest');
        if (!$pluginInfo) {
            return parent::getFullRequest();
        } else {
            return $this->___callPlugins('getFullRequest', func_get_args(), $pluginInfo);
        }
    }
