<?php
namespace Navin\Bestseller\Block\CategoryId;

/**
 * Interceptor class for @see \Navin\Bestseller\Block\CategoryId
 */
class Interceptor extends \Navin\Bestseller\Block\CategoryId implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductCategoryId');
        if (!$pluginInfo) {
            return parent::getProductCategoryId();
        } else {
            return $this->___callPlugins('getProductCategoryId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductCacheKey');
        if (!$pluginInfo) {
            return parent::getProductCacheKey();
        } else {
            return $this->___callPlugins('getProductCacheKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConfigValue($config)
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfigValue($config);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStartOfDayDate');
        if (!$pluginInfo) {
            return parent::getStartOfDayDate();
        } else {
            return $this->___callPlugins('getStartOfDayDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEndOfDayDate');
        if (!$pluginInfo) {
            return parent::getEndOfDayDate();
        } else {
            return $this->___callPlugins('getEndOfDayDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllConfigValues');
        if (!$pluginInfo) {
            return parent::getAllConfigValues();
        } else {
            return $this->___callPlugins('getAllConfigValues', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUniqueSliderKey');
        if (!$pluginInfo) {
            return parent::getUniqueSliderKey();
        } else {
            return $this->___callPlugins('getUniqueSliderKey', func_get_args(), $pluginInfo);
        }
    }
